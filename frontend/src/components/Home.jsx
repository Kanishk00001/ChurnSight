    ...
    <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center text-center py-16 px-6">
      ...
      <div className="max-w-4xl">
        <h1 className="text-5xl font-bold text-gray-900 leading-tight">
          Unlock Customer Retention with{" "}
          <span className="text-indigo-600">AI-Powered Insights</span>
        </h1>
        <p className="mt-6 text-lg text-gray-600">
          Our advanced churn prediction platform helps businesses identify
          at-risk customers, analyze engagement patterns, and create data-driven
      ...
      <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl">
        <Link 
        to="/telecom"
        className="bg-white rounded-lg shadow-lg  transform hover:scale-105 transition duration-300">
          <img
            src={LOGO1}
